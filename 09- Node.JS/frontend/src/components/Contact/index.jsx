...
function newMsg(event) {
    ...
    let form = {'nome': nome, 'msg': mensagem};
    ...
    <div  className="container d-flex ">
      ...
      <form onSubmit={newMsg} className="formGroup">
        ...
        <input  type="text" required name="nome" placeholder="Seu nome completo" value={nome} onChange={event=>setNome(event.target.value)}/>
        <br/> <label className="contato">Envie uma mensagem:</label>
        <textarea className="mensagem" required type="text" name="msg" placeholder="Eai, qual produto quer comprar?" value={mensagem} onChange={event=>setMensagem(event.target.value)}></textarea>
        </div>
